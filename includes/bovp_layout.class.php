...
*/
	...
	#show title
	function showTitle($title, $echo = true) {
	...
	#font_size
	function showFontSize($echo = true) {
	...
	#share
	function showShareButtons($share, $echo = true) {
	...
	#search
	function showFormSearch($echo = true, $icone = false) {

		$return  = "<div class='bovp_search_container'>";

		$return .= "<form method='post' action='" . BOVP_URL  . "' name='bovp_form_search' class='bovp_form_search bovp_clear'>";
	...
	#active version
	function showVersion($echo = true) {
